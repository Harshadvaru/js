...
>js creation Phase
    ...
    3> Execution Phase
        val1 <-- 10
        val2 <-- 5
        addNum --> [new variable enviroment + Execution thread] crate box and once again create  Memory Phase and Execution Phase execute the process and perform operation]